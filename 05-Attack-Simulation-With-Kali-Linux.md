...
This section shows the execution of an RDP brute-force simulation using `Crowbar` on Kali Linux to demonstrate how automated attacks exploit weak credentials. This demonstration will show why having a strict password 
policy is important for keeping users and organization secure.  
